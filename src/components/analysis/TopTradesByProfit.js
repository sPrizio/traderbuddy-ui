...
export default class TopTradesByProfit extends Component {
                ...
                <div className="card">
                    <div className="card-content">
                        ...
                        <div className={"" + (this.state.isLoading ? ' no-show ' : '')}>
                            <h5 className="header">
                                P&L {this.props.sortByLosses ? 'Lost' : 'Gained'}
                            </h5>
                                                ...
                                                <div className="column is-12 performance-statistics-entry" key={key}>
                                                    <div className="columns is-multiline is-mobile is-vcentered">
                                                        ...
                                                        <div className="column is-4 has-text-right">
                                                            <h5 className="value">{item.netProfit}</h5>
