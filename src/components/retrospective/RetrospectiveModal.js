                        ...
                        <div className="columns is-multiline">
                            ...
                            <div className="column is-12">
                                ...
                                <div className="columns is-multiline is-vcentered">
                                    ...
                                    <div className="column is-12">
                                        {
                                            this.state.retroData.points && this.state.retroData.points.map((item, key) => {
                                                return (
                    ...
                    <footer className="modal-card-foot">
                        <button className="button is-primary" onClick={() => {
                            if (this.state.retroData.startDate.length === 0 && this.state.retroData.endDate.length === 0) {
                                ...
                                this.props.handleSubmit(this.state.retroData)
                            }
                        }}>Save changes</button>
                        <button className="button" onClick={() => {
                            this.setState({isInvalidDate: false})
                            this.props.toggleModal(this.props.modalActive)
                        }}>Cancel
                        </button>
                    </footer>
                </div>
